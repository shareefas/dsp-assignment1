...
Original file is located at
    https://colab.research.google.com/drive/1v007Y25gCiftMQtal-emAe1xgJiAV1sQ
"""
...
[16.6800,80.7852],[16.5062, 80.6480],[16.2379,80.6444],[16.2379,80.6444],[15.5057,80.0499],[15.0960, 79.4113]]

coords_2=[[16.7850, 80.8488],
[16.6800,80.7852],[16.5419,80.8050],[16.5062, 80.6480],[16.0948,80.1656],[15.9938,80.1038],[15.8107,79.9724],[15.7245,80.0189],[15.5057,80.0499],[15.2197, 79.9025],[15.0960, 79.4113]]

coords_3=[[16.7850, 80.8488],
[16.6356,80.9716],[16.5419,80.8050],[16.5062, 80.6480],[16.2356,80.5605],[15.9039,80.4671],[15.5057,80.0499],[15.1686, 79.7316],[15.0960, 79.4113]]
...
folium.Marker(location=[15.0960, 79.4113],popup='<strong>temple</strong>',tooltip='<strong>golden bekary</strong>',icon=folium.Icon(color='orange',prefix='fa',icon='fa-ship')).add_to(map1)
map1
